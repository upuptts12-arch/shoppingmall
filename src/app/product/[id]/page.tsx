...
const PRODUCT_DETAILS: Record<number, ProductDetail> = {
  1: {
    ...
    category: "Top",
    image:
      "https://search.pstatic.net/common/?src=https%3A%2F%2Fshop-phinf.pstatic.net%2F20240709_64%2F1720495098771h1s8N_JPEG%2F74467495799017641_831995182.jpg&type=sc960_832",
    summary:
...
하나만 가지고 있어도 데일리룩 걱정 줄여주는, 진짜 기본템 후드예요.`,
  ...
  2: {
    ...
    category: "Bottom",
    image:
    "https://img.29cm.co.kr/item/202311/11ee7f8015889d4983bca9f3234b3bef.jpg?width=700&format=webp",
    summary:
...
L : 허리 40  힙 54  허벅지 32  밑위 30  밑단 24  총장 102`,
    ...
    lining: "없음",
    seeThrough: "없음",
    notice: "워싱 특성상 제품마다 미세한 컬러 차이와 스크래치는 자연스러운 현상입니다.",
    origin: "베트남",
    manufacturer: "협력업체",
...
평소 데님 자주 입으신다면, 꼭 하나쯤 가지고 있으면 좋을 데일리 팬츠입니다.`,
  ...
  3: {
    ...
    category: "Shoes",
    image:
      "https://search.pstatic.net/common/?src=https%3A%2F%2Fshopping-phinf.pstatic.net%2Fmain_3323264%2F33232645754.jpg&type=f372_372",
    summary:
...
데일리용 운동화를 찾고 계시다면 가성비 좋은 선택이 될 거예요.`,
  ...
  4: {
    ...
    category: "Bag",
    image:
      "https://search.pstatic.net/common/?src=https%3A%2F%2Fshopping-phinf.pstatic.net%2Fmain_5786146%2F57861466417.jpg&type=f372_372",
    summary:
...
개인적으로 ‘옷은 심플한데 가방으로 포인트 주고 싶은 날’에 추천드리고 싶은 아이템입니다.`,
  ...
  5: {
    ...
    category: "Top",
    image:
      "https://search.pstatic.net/common/?src=http%3A%2F%2Fcafefiles.naver.net%2FMjAxNzA4MTZfMjUw%2FMDAxNTAyODYxNjM3OTQz.Tb69xoTosvYHgxmuoh_ubg8AK_qKZQxbVVMGL1Vn6U4g.wJ8zBcj6xd2c01-hgfdzxvETuzxCf03ZKgt1SoQeDiYg.JPEG.cjhye6603%2Fnv_1502861636050.jpg&type=a340",
    summary:
...
어깨 52  가슴 59  암홀 24  소매 57  총장 73`,
    ...
    lining: "없음",
    seeThrough:
      "밝은 컬러는 약간 비침이 있을 수 있습니다. (스킨톤 이너 권장)",
...
하나쯤 갖고 있으면 봄·가을은 물론, 사계절 내내 활용하기 좋은 기본 셔츠예요.`,
  ...
  6: {
    ...
    category: "Bottom",
    image:
      "https://search.pstatic.net/common/?src=http%3A%2F%2Fshopping.phinf.naver.net%2Fmain_5518624%2F55186244250.20250607213922.jpg&type=a340",
    summary:
...
허리 32~42(밴딩)  힙 54  허벅지 32  밑위 30  밑단 12~18(시보리)  총장 100`,
    ...
    seeThrough: "없음",
    notice:
      "밴딩 특성상 사이즈 측정 시 1~3cm 정도 오차가 있을 수 있습니다.",
    origin: "중국",
    manufacturer: "협력업체",
    shipping: "지금 주문 시 영업일 기준 1~3일 내 출고됩니다.",
