...
허리 32~42(밴딩)  힙 54  허벅지 32  밑위 30  밑단 12~18(시보리)  총장 100`,
    ...
    manufacturer: '협력업체',
    shipping: '지금 주문 시 영업일 기준 1~3일 내 출고됩니다.',
    comment: `허리 전체 밴딩과 스트링 덕분에 체형에 크게 구애받지 않고 s편하게 입을 수 있어요.
...
편하면서도 스타일 놓치기 싫은 날, 손이 자주 갈 조거 팬츠입니다.`,
  ...
  7: {
    ...
    category: 'Top',
    image: '/pink.png',
    summary: '도톰한 기모 원단의 박시핏 후드 스웨터 코트. 은은한 핑크 컬러.',
    sizeInfo: `FREE
어깨 63 가슴 66 소매 52 총장 76`,
    fabric: '폴리 65% 코튼 35%',
    thickness: '두꺼움',
    stretch: '있음',
    lining: '기모 있음',
    ...
    manufacturer: '협력업체',
    shipping: '2~3일 내 출고',
    comment: `핑크 컬러가 얼굴 톤을 살려주는 포인트 아우터.`,
  },
  8: {
    ...
    category: 'Top',
    image: '/플라워.jpg',
    summary: '플라워 패턴과 오프숄더 디자인이 조화를 이루는 빈티지 니트.',
    sizeInfo: `FREE
어깨 43 가슴 46 소매 52 총장 46`,
    fabric: '아크릴 80% 나일론 20%',
    thickness: '보통',
    stretch: '좋음',
    lining: '없음',
    seeThrough: '없음',
    notice: '니트는 옷걸이 보관 시 늘어날 수 있음',
    origin: '한국',
    manufacturer: '협력업체',
    shipping: '1~3일 내 출고',
    comment: `여리여리하게 떨어지는 핏으로 데일리 코디 가능.`,
  },
  ...
  9: {
    ...
    category: 'Bottom',
    image: '/사이드 핀턱.jpg',
    summary: '핀턱 디테일로 다리를 슬림하게 보이게 하는 와이드 팬츠.',
    sizeInfo: `S / M / L`,
    fabric: '코튼 100%',
    thickness: '보통',
    stretch: '없음',
    lining: '없음',
    seeThrough: '없음',
    notice: '워싱 특성상 색 차이 있음',
    origin: '베트남',
    manufacturer: '협력업체',
    shipping: '1~3일 내 출고',
    comment: `기본 와이드 팬츠로 활용도 매우 높음.`,
  },
  ...
  10: {
    ...
    category: 'Bottom',
    image: '/트레이닝.jpg',
    summary: '겨울용 코듀로이 트레이닝 팬츠. 따뜻한 기모 안감.',
    sizeInfo: `FREE`,
    fabric: '코튼 97% 스판 3%',
    thickness: '두꺼움',
    stretch: '좋음',
  ...
  11: {
    ...
    category: 'Shoes',
    image: '/아디다스.jpg',
    summary: '삼바 스타일의 로우 스니커즈. 가벼운 착화감.',
    sizeInfo: `230~280`,
    fabric: '가죽 + 러버솔',
    thickness: '보통',
    stretch: '없음',
  ...
  13: {
    ...
    category: 'Bag',
    image: '/스웨이드.jpg',
    summary: '부드러운 스웨이드 질감의 미니 숄더백.',
    sizeInfo: `가로 26 세로 17 폭 6`,
    fabric: '합성 스웨이드',
    thickness: '보통',
    stretch: '없음',
    lining: '없음',
    seeThrough: '없음',
    notice: '물 닿으면 얼룩 생길 수 있음',
    origin: '중국',
    manufacturer: '협력업체',
    shipping: '1~2일 내 출고',
    comment: `데일리로 들기 좋은 미니 백.`,
  },
  ...
  14: {
    ...
    category: 'Bag',
    image: '/무센트.jpg',
    summary: '심플한 로고 자수 디자인의 데일리 백팩.',
    sizeInfo: `가로 30 세로 42 폭 14`,
    fabric: '폴리에스터 100%',
    thickness: '보통',
    stretch: '없음',
    lining: '있음',
